  ...
  return (
    <div className="App" id="app">
      ...
      <div className="faqSection" id="faqsection">
        ...
        <button className="question" onClick={e => triggerCollapse(3)}>What is the dress code?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(7)}>Are kids invited?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(8)}>Is there parking available at the venue?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(9)}>Is this an indoor or outdoor event?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(10)}>What transportation options will be available in the area?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(11)}>What is the weather like in the area?</button>
        <div className="answerDiv">
        ...
        <button className="question" onClick={e => triggerCollapse(12)}>What is the wedding day itinerary?</button>
        <div className="answerDiv">
